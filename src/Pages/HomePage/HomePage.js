...
const HomePage = () => {
  ...
  observer.observe(document.querySelector('.formations'));    
  observer.observe(document.querySelector('.presentation-h1'));    
  observer.observe(document.querySelector('.presentation-p'));    
  observer.observe(document.querySelector('.equipe-for-each'));    
  observer.observe(document.querySelector('.equipe-member-list'));    

  return () => {
    observer.unobserve(document.querySelector('.formation-cards'));    
    observer.unobserve(document.querySelector('.formations'));    
    observer.unobserve(document.querySelector('.presentation-h1'));    
    observer.unobserve(document.querySelector('.presentation-p'));    
    observer.unobserve(document.querySelector('.equipe-for-each'));    
    observer.unobserve(document.querySelector('.equipe-member-list'));    
  }
