    ...
    <div className="practical_life_section">
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            des stagiaires ainsi qu’une salle de restauration où il est possible
            de prendre ses repas sur place. Il est demandé à chacun d’être
            responsable de cet espace et de veiller à sa propreté.
          </li>
        </ul>
        <ul>
          <li>
          ...
          <li>
            ...
            autoriser la remise de l'attestation de formation. Cela peut être le
            cas si le stagiaire a été renvoyé temporairement, n'a pas été assidu
            ou a récidivé après des sanctions initiales (ex : absences
        ...
        <div id="practical_life_evalutation_container">
          ...
          <ul class="practical_life_evaluation">
            <li class="practical_life_list_style">
              D’un entretien individuel mené avec chacun des stagiaires quant à
              leur positionnement dans le contexte de la formation (compétences
              à développer, adéquation du stagiaire en regard du métier visé via
              la formation, etc.).
            </li>
            <li class="practical_life_list_style">
          ...
          <ul class="practical_life_evaluation">
            <li>
              ...
              formation et permet de vérifier si les objectifs pédagogiques ont
              été atteints et si la formation est validée en termes
      ...
      <div>
        <ul>
          ...
          <li>
            Le stagiaire doit prendre connaissance du règlement intérieur et s’y
            conformer.
          </li>
        </ul>
        <ul>
        ...
        <ul>
          ...
          <li>
            ...
            des autres en respectant les consignes générales et particulières de
            sécurité et d’hygiène en vigueur sur le lieu de formation.
          </li>
          <li>
            Tout accident ou incident survenu à l'occasion ou en cours de
            formation doit être immédiatement déclaré par le stagiaire accidenté
            ou les personnes témoins de l'accident au responsable de la
            formation ou à son représentant.
          </li>
          <li>
      ...
      <div>
        ...
        <ul>
          <li>
            ...
            vos demandes, d’assurer nos prestations de formation et d’améliorer
            la qualité de nos services. Elles servent aussi à mieux vous
            connaitre pour vous proposer des contenus et des formations
            personnalisées, adaptés à vos besoins. FOREACH ACADEMY s’engage à ce
            que la collecte et le traitement de vos données soient conformes au
            Règlement général sur la protection des données (RGPD) et à la loi
            informatique et libertés du 6 janvier 1978 modifiée, en matière de
        ...
        <ul>
          <li>
            ...
            informations, la présente charte de confidentialité vous informe de
            la manière dont nous recueillons et traitons vos données
            personnelles. Nous vous invitons à la lire attentivement.Nous nous
            réservons le droit de modifier la présente charte de confidentialité
            à tout moment. Vous en serez alors informés.
          </li>
        </ul>
        <ul>
          ...
          <li>
            ...
            par exemple pouvoir vous contacter à propos de différents événements
            relatifs à FOREACH ACADEMY.
          </li>
        </ul>
        <ul>
          Dans tous les cas, vos données personnelles ne sont utilisées que dans
          le cadre de votre formation ou de votre projet professionnel.
        </ul>
        <ul>
          <li className="bold_policy_chapter">
          ...
          <li>
            ...
            concernent. Elles sont collectées notamment lors d’une demande
            d’information ou un intérêt de votre part concernant notre offre de
            formation.
          </li>
        </ul>
        <ul>
        ...
        <ul>
          ...
          <li>
            FOREACH ACADEMY ne collecte aucune donnée sensible vous concernant.
            Sont considérés comme des données sensibles : l’origine raciale ou
            ethnique, les opinions politiques, les croyances religieuses ou
            philosophiques, l’adhésion à un syndicat, les données relatives à
            l’orientation sexuelle. Si de telles informations étaient d’une
            manière ou d’une autre communiquées à FOREACH ACADEMY, elles seront
            supprimées.
          </li>
        </ul>
        <ul>
        ...
        <ul>
          ...
          <li>Sont susceptibles d’avoir accès à certaines de vos données :</li>
          <li>
          ...
          <li>
            - Les formateurs : qui assurent les prestations de formation et qui
            doivent pouvoir vous fournir les informations nécessaires au bon
          ...
          <li>
            ...
            garantir les droits, les biens et la sécurité de FOREACH ACADEMY.
          </li>
        </ul>
        <ul>
          <li>
          ...
          <li>
            - A des fins d’exécution de votre contrat ou convention de formation
          </li>
        ...
        <div id="rights">
          <ul>
            ...
            <li>
              ...
              t’encadrer tout au long de ton contrat et te donner des missions
              correspondantes à une fiche de poste. Ce contrat définit les
            ...
            <li>
              ...
              restauration, etc. Tu bénéficies des dispositions législatives,
              réglementaires ou conventionnelles applicables aux autres salariés
              de ton entreprise.
            </li>
